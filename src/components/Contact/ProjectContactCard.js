...
class ProjectContactCard extends Component {
  ...
  return (
    <Grid container>
      <Grid.Column computer={9} className="profile-card extended-card">
...
export default connect(mapStateToProps)(ProjectContactCard);
