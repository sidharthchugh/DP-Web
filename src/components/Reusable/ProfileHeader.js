    ...
    const links = [
       {
        ...
        mobileClassName: 'btn-header-mobile mobilemarg0',
        iconName: 'newspaper-o',
        textContent: strings.webAppNav6
      },
      {
        linkTo: '/profile',
        activeClassName: 'activeHeader',
...
export default connect(mapStateToProps, {fetchProfiles})(ProfileHeaderContainer);
