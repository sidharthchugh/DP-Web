...
class SettingsForm extends Component {
  ...
  render() {
    const {handleSubmit, settingsDetails, userLanguage} = this.props;
    const newsLetter = (newsletterValue) => {
      if (!newsletterValue) {
        return userLanguage === 'German' ? 'Sie sind nicht für den Newsletter angemeldet.' : 'You are not subscribed to the Newsletter';
      }
         return userLanguage === 'German' ? 'Sie sind für den Newsletter angemeldet.' : 'You are subscribed to the Newsletter';
    };
    return (
      <form onSubmit={handleSubmit} className="settings-form topSettings">
        <div className="edit-save-wrapper">
          <a className="edit-button edit-settings" onClick={event => this.enterEditMode(event)}>
            <img src={editIcon} role="presentation" /> {userLanguage === 'German' ? 'Bearbeiten' : 'Edit'}
          </a>
          <div id="setting-save-cancel-wrapper" className="save-cancel-button save-settings">
            ...
            >
              {userLanguage === 'German' ? 'Abbrechen' : 'Cancel'}
            </Button>
            <Button
              className="button-small"
              type="submit"
              onClick={event => this.cancelEditMode(event)}> {userLanguage === 'German' ? 'Speichern' : 'Save'}</Button>
          </div>
        </div>
        <Grid>
          <Grid.Column computer={6} tablet={6} mobile={12} className="bigger-input no-vertical-padding">
            <div className="profile-label settings-label">{userLanguage === 'German' ? settingsDetails.SettingsInfo[0].germanLabel : settingsDetails.SettingsInfo[0].englishLabel}</div>
          ...
          <Grid.Column computer={6} tablet={6} mobile={12} className="end bigger-input no-vertical-padding">
            <div className="profile-label settings-label">{userLanguage === 'German' ? settingsDetails.SettingsInfo[1].germanLabel : settingsDetails.SettingsInfo[1].englishLabel}</div>
          ...
          <Grid.Column computer={12} className="no-vertical-padding">
            <div className="profile-label settings-label">{userLanguage === 'German' ? settingsDetails.SettingsInfo[2].germanLabel : settingsDetails.SettingsInfo[2].englishLabel}</div>
          ...
          <Grid.Column computer={12} className="no-vertical-padding">
            <div className="profile-label settings-label">{userLanguage === 'German' ? settingsDetails.SettingsInfo[3].germanLabel : settingsDetails.SettingsInfo[3].englishLabel}</div>
          ...
          <Grid.Column computer={12} className="no-vertical-padding">
            <div className="profile-label settings-label">{userLanguage === 'German' ? settingsDetails.SettingsInfo[4].germanLabel : settingsDetails.SettingsInfo[4].englishLabel}</div>
          ...
          <Grid.Column computer={12} className="no-vertical-padding">
            <div className="profile-label settings-label">{userLanguage === 'German' ? settingsDetails.SettingsInfo[5].germanLabel : settingsDetails.SettingsInfo[5].englishLabel}</div>
          ...
          <Grid.Column computer={12} className="no-vertical-padding">
            <div className="profile-label settings-label">{userLanguage === 'German' ? settingsDetails.SettingsInfo[6].germanLabel : settingsDetails.SettingsInfo[6].englishLabel}</div>
          ...
          <Grid.Column computer={12} className="no-vertical-padding">
            <div className="profile-label settings-label">{userLanguage === 'German' ? settingsDetails.SettingsInfo[7].germanLabel : settingsDetails.SettingsInfo[7].englishLabel}</div>
...
SettingsForm = connect(
  (state, ownProps) => {
    ...
    return {
      initialValues: ownProps.settingsValues,
