  ...
  return (
    ...
    <Segment className="mainPage-firstSection">
      <Container className="mainPage-container">
       ...
       <h2>EMPOWERING TECHNOLOGY <br />PARTNERSHIPS</h2>
       <h4>We make digital technology accessible to any business, to build a more <br /> innovative, collaborative and sustainable economy together.</h4>
       <Link to="/signup">
       <Button onClick={this.props.isLogin ? this.props.toggleLoginMode : null}>Start Innovation</Button>
        </Link> 
       </Grid.Column>
       </Container>
    </Segment>
...
export default connect(mapStateToProps, {notify, toggleLoginMode, addNotification})(CommingSoon);
