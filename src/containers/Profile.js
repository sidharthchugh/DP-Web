        ...
        <Grid.Column computer={12}>
          <Grid container>
            ...
            <Grid.Column tablet={12} computer={9}>
              <StickyContainer>
                <ProfileCard userLanguage={userLanguage} strings={strings} />
              </StickyContainer>
            </Grid.Column>
            <Grid.Column tablet={12} computer={3} textAlign="center">
              <div className="profile-page-right-sidebarnav">
                <StickyContainer>
                  <ProfileCard userLanguage={userLanguage} strings={strings} sidebar={'true'} />
                </StickyContainer>
              </div>
