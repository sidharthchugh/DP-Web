            ...
            <Grid container>
              ...
              <Grid.Column tablet={12} computer={3} textAlign="center">
                <div className="profile-page-right-sidebarnavSearch">
                  <SidebarSearches userLanguage={userLanguage} strings={strings} />
                </div>
...
export default connect(mapStateToProps, {addNotification, updateSearches, toggleSearchEdit})(Search);
